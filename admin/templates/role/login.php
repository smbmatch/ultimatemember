<div class="um-admin-metabox">
	...
	<div class="">
		...
		<p>
			...
			<span class="um-admin-half">
				...
				<select name="_um_after_login" id="_um_after_login" class="umaf-selectjs um-adm-conditional" style="width: 300px" data-cond1="redirect_url" data-cond1-show="_um_after_login"
						data-cond2="redirect_relative" data-cond2-show="_um_after_login">
					...
					<option value="redirect_relative" <?php selected('redirect_relative', $ultimatemember->query->get_meta_value('_um_after_login') ); ?>><?php _e('Redirect to relative URL on this site','ultimatemember'); ?></option>
		...
		<p class="_um_after_login">
			<label class="um-admin-half" for="_um_login_redirect_url"><?php _e('Set Custom Redirect URL','ultimatemember'); ?> <?php $this->tooltip( __('Set a (possibly relative) url to redirect this user role to after they login with their account','ultimatemember') ); ?></label>
			<span class="um-admin-half">
